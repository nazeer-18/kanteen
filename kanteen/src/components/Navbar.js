            ...
            <div className="sidenav">
                ...
                <div className="sidenav-content">
                    <div className="sidenav-link">
                        <Link onClick={handleResponsiveness} exact="true" to="/"><div> Home </div></Link>
                        <Link onClick={handleResponsiveness} exact="true" to="/menu"><div> Order </div></Link>
                        <Link onClick={handleResponsiveness} exact="true" to="/orderhistory"><div> Order History </div></Link>
                        <Link onClick={handleResponsiveness} exact="true" to="/transaction"><div> Transaction </div></Link>
                        <Link onClick={handleResponsiveness} exact="true" to="/editprofile"><div> Edit Profile </div></Link>
                    </div>
                </div>
            </div>
